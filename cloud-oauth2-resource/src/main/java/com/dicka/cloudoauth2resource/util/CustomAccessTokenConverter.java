...
public class CustomAccessTokenConverter implements AccessTokenConverter,
        ...
        if (map.containsKey(SCOPE)){
            Object scopeObj = map.get(SCOPE);
                if(String.class.isInstance(scopeObj))
                    scope = new LinkedHashSet<String>(Arrays
                            .asList(String.class.cast(scopeObj).split(" ")));
    ...
    public OAuth2Authentication extractAuthentication(Map<String, ?> map) {
        ...
        OAuth2Request request = new OAuth2Request(
                parameters, clientId, authorities, true, scope, resourceIds,
                null, null, null
        );
